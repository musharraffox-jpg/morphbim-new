...
const Newsletter2 = () => {
  ...
  return (
    <section id="newsletter" className="bg-white py-16 md:py-24 relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="absolute top-10 left-10 w-[300px] h-[300px] bg-gray-100 rounded-full blur-3xl"></div>
      <div className="absolute bottom-10 right-10 w-[300px] h-[300px] bg-gray-100 rounded-full blur-3xl"></div>
      
      {/* Decorative shapes */}
      <div className="absolute top-1/4 left-10 md:left-20 w-16 h-16 rounded-full border-2 border-gray-200 opacity-60"></div>
      <div className="absolute bottom-1/4 right-10 md:right-20 w-24 h-24 rounded-lg border-2 border-gray-200 opacity-60 rotate-45"></div>
      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto relative z-10">
        <div className="max-w-6xl mx-auto bg-white rounded-2xl p-8 md:p-12 shadow-[0_10px_60px_-15px_rgba(0,0,0,0.1)] opacity-0 animate-on-scroll backdrop-blur-sm border border-gray-100">
          {/* Decorative icon */}
          <div className="mx-auto mb-8 w-16 h-16 rounded-full bg-gray-800 flex items-center justify-center shadow-lg">
            <Mail className="w-8 h-8 text-white" />
          </div>
          
          <div className="text-center mb-8">
            <h2 className="text-3xl sm:text-4xl font-display font-bold mb-4 text-gray-800">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-grow">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-5 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent shadow-sm text-gray-700" 
                  required 
                />
              </div>
              <button 
                ...
                className="bg-gray-800 hover:bg-gray-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center shadow-md"
              >
  ...
  return <section id="newsletter" className="bg-white py-0">
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-5xl font-display font-bold mb-4 text-left">Stay Informed with Industry Insights</h2>
