  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "You'll receive updates about Morphvison's BIM services soon."
      });
      setEmail("");
      ...
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-gray-700 mb-10 text-left">
            Be the first to hear about our latest projects, BIM innovations, and industry insights.
          </p>
