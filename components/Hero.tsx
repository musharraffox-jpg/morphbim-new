      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Empower Your Projects<br className="hidden sm:inline" />with Cutting-Edge BIM Solutions
            </h1>
            ...
            >
              From concept to completion, Morphvison delivers precision, efficiency, and innovation in every phase of your construction journey.
            </p>
